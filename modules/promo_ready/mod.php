...
class promo_readyCsp extends moduleCsp {
	...
	public function getPromoTemplates() {
		...
		//foreach($data as $key => $d) {
			$data[ 'csp_tpl_mercury' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temmercury&utm_campaign=com';
			$data[ 'csp_tpl_myfactory' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temfactory&utm_campaign=com';
			$data[ 'csp_tpl_saenna' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temsaena&utm_campaign=com';
			$data[ 'csp_tpl_flattern' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temflattern&utm_campaign=com';
			
			$data[ 'csp_tpl_intime' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temintime&utm_campaign=com';
			$data[ 'csp_tpl_klif' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temklif&utm_campaign=com';
			$data[ 'csp_tpl_minigo' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temminigo&utm_campaign=com';
			$data[ 'csp_tpl_sonoran' ]['link'] = 'http://readyshoppingcart.com/product/coming-soon-plugin-pro-version/?utm_source=compro&utm_medium=temsonoran&utm_campaign=com';
